  ...
  items: [
    {
      ...
      body: "Darah alami yang keluar dari rahim wanita sehat, biasanya setiap bulan. Mayoritas ulama: minimal 1 hari semalam, maksimal 15 hari. Antara dua haid minimal 13 hari suci. Pendapat sebagian ulama (Ibn Taimiyyah, Ibn Utsaimin): tidak ada batas minimal/maksimal — patokan utama adalah kebiasaan & sifat darah.",
      source: "QS. Al-Baqarah: 222; HR. Al-Bukhari no. 320, Muslim no. 333",
    },
    {
      title: "Yang dilarang saat haid",
      body: "Sholat (tidak diqadha), puasa (diqadha setelah suci), thawaf di Ka'bah, menyentuh mushaf (jumhur), berhubungan suami-istri di kemaluan, i'tikaf. Aisyah RA: Rasulullah ﷺ tetap dekat dengan istri-istrinya yang haid — boleh makan bersama, tidur bersama, sentuh, kecuali jima'.",
      source: "HR. Al-Bukhari no. 305, Muslim no. 1211 (haji); Muslim no. 293 (Aisyah)",
    },
    {
      title: "Tidak ada qadha sholat — tegas",
      body: "Aisyah RA berkata: 'Kami pernah haid di zaman Rasulullah ﷺ. Kami diperintah mengqadha puasa, dan tidak diperintah mengqadha sholat.' Allah memberi keringanan, bukan menambah beban.",
      source: "HR. Muslim no. 335",
    },
    {
      title: "Yang tetap boleh & dianjurkan",
      body: "Dzikir (semua bentuk), doa, sholawat, mendengar Al-Qur'an, menghadiri majelis ilmu, sedekah, akhlak baik. Imam Bukhari, Imam Malik, dan sebagian ulama membolehkan membaca Al-Qur'an dengan lisan (tanpa menyentuh mushaf) — pendapat ini kuat. Imam Nawawi dan jumhur: tidak boleh. Pilih yang menentramkan hatimu, dengan ilmu.",
      source: "HR. Al-Bukhari no. 305 (Aisyah melakukan semua amalan haji selain thawaf)",
    },
    {
      title: "Cara berakhirnya haid",
      body: "Diketahui dari berhentinya darah dan tampaknya 'qashshatul baidha'' (lendir putih bersih) atau jika kering. Lalu wajib mandi besar (mandi janabah) untuk kembali sholat. Tidak ada pendapat menunggu hari tertentu — patokan utama: berhentinya darah.",
      source: "HR. Al-Bukhari no. 320 (Aisyah RA tentang qashshatul baidha)",
    },
    {
      title: "Mandi setelah haid",
      body: "Niat mengangkat hadats besar, baca Bismillāh, basuh tangan 3x, bersihkan kemaluan, wudhu sempurna, siram kepala 3x sampai air ke akar rambut, lalu siram seluruh badan dimulai dari kanan. Wanita boleh tidak melepas jepit/ikat rambut, asal air sampai ke akar.",
      source: "HR. Al-Bukhari no. 248, Muslim no. 316 (cara mandi Rasulullah); Muslim no. 330 (rambut wanita)",
    },
    {
      title: "Nifas (Pasca Melahirkan)",
      body: "Darah yang keluar setelah melahirkan. Mayoritas ulama (Hanafi, Hanbali): maksimal 40 hari. Tidak ada minimal — kalau berhenti sebelum 40 hari, sudah suci & wajib mandi. Hukumnya seperti haid: tidak sholat (tidak diqadha), tidak puasa (diqadha), dst.",
      source: "HR. Abu Dawud no. 311, At-Tirmidzi no. 139, hasan",
    },
    {
      title: "Setelah nifas berhenti",
      body: "Walau belum 40 hari, jika darah sudah berhenti dan sudah suci → wajib mandi dan kembali beribadah. Tidak menunggu 40 hari penuh — itu hanya batas maksimal.",
      source: "Konsensus mayoritas ulama berdasarkan praktik para sahabat",
    },
    {
      title: "Istihadhah (Darah Penyakit)",
      body: "Darah di luar masa haid normal — bisa karena sakit, hormonal, atau setelah masa haid biasa. Hukumnya BUKAN seperti haid: tetap sholat, puasa, dan ibadah biasa. Wanita istihadhah TETAP berkewajiban sholat — bukan udzur untuk meninggalkannya.",
      source: "HR. Al-Bukhari no. 228, Muslim no. 333 (kasus Fatimah binti Hubaisy)",
    },
    {
      title: "Cara wanita istihadhah berwudhu",
      body: "Cuci kemaluan, pakai pembalut, wudhu setiap masuk waktu sholat. Boleh menggabungkan beberapa sholat dengan satu wudhu jika diperlukan — Islam memberi keringanan, dan setiap kali keluar darah saat wudhu tidak membatalkan wudhunya.",
      source: "HR. Abu Dawud no. 297, At-Tirmidzi no. 126, sahih",
    },
    {
      title: "Membedakan haid dan istihadhah",
      body: "Haid: warna kehitaman/merah pekat, kental, bau khas, datang di siklus rutin. Istihadhah: lebih cair, di luar siklus, kadang berwarna lebih cerah. Jika ragu, kembali ke kebiasaan siklus haidmu — itu yang dijadikan patokan.",
      source: "HR. An-Nasa'i no. 215, Abu Dawud no. 304, sahih",
    },
    {
      title: "Mengganti puasa & thawaf",
      body: "Puasa Ramadhan yang ditinggalkan karena haid → wajib diqadha sebelum Ramadhan berikutnya. Sholat TIDAK DIQADHA — Allah memberi keringanan, bukan beban tambahan. Thawaf yang tertinggal saat haji: tunggu sampai suci, lalu thawaf.",
      source: "HR. Muslim no. 335 (puasa qadha, sholat tidak); HR. Al-Bukhari no. 305 (thawaf)",
    },
    {
      title: "Bagi yang masih remaja",
      body: "Tidak perlu malu — ini pintu kewajiban (mukallaf), tanda Allah memuliakanmu jadi hamba dewasa. Ibumu, gurumu, atau muslimah yang lebih senior bisa membimbingmu. Tubuhmu adalah amanah, bukan aib.",
    },
  ],
